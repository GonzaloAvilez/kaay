...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            ...
            name='order',
            field=models.ForeignKey(on_delete='id', related_name='items', to='orders.Order', to_field='Order'),
        ),
        migrations.AlterField(
            model_name='orderitem',
            name='price',
        ...
        migrations.AlterField(
            model_name='orderitem',
            name='product',
            field=models.ForeignKey(on_delete='id', related_name='order_items', to='shop.Product', to_field='Product'),
        ),
        migrations.AlterField(
            model_name='orderitem',
            name='quantity',
